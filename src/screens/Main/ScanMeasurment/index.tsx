...
const ScanMeasurmentScreen: React.FC = () => {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                >
                    ...
                    <View
                        style={styles.viewsAlign}
                    >
                        <View style={[styles.miniViews, { backgroundColor: theme.colors.green }]} />
                        <View style={[styles.miniViews, { backgroundColor: theme.colors.white }]} />
            ...
            >
                <View
                    style={[styles.alertView, { backgroundColor: data[step].bg }]}
                >
                    <Image
                ...
                >
                    ...
                    >
                        <View
                            style={[styles.cameraButton, {backgroundColor: data[step].containerbg}]}
                        >
                            <Image
