    ...
    return (
        <>
            ...
            >
                ...
                >
                    <CustomText
                        text={"A sua viagem de medição corporal começa aqui — simples, inteligente e precisa. A sua viagem de medição corporal começa aqui — simples, inteligente e precisa."}
                        size={28}
